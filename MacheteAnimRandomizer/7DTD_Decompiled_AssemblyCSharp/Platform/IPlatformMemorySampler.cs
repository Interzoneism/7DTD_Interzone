...
namespace Platform
{
	...
	public interface IPlatformMemorySampler
	{
		...
		// (get) Token: 0x0600B722 RID: 46882
		IReadOnlyList<IPlatformMemoryStat> Statistics { get; }

		// Token: 0x0600B723 RID: 46883
		bool HasImportantChange();

		// Token: 0x0600B724 RID: 46884
		void Sample();

		// Token: 0x0600B725 RID: 46885 RVA: 0x00467908 File Offset: 0x00465B08
		void UpdateLast()
		{
		...
		// Token: 0x0600B726 RID: 46886 RVA: 0x00467954 File Offset: 0x00465B54
